...
@XmlRootElement(name = "APARTMENTTYPE")

public class ApartmentType extends FiasObject{
    ...
    private String insertStatement = "insert into fias_gar.apartment_types(id, name, shortname, \"desc\", updatedate, startdate, enddate, isactive)";
    ...
    public String getInsertStatement(){
        //insert into fias_gar.apartment_types(id, name, shortname, desc, updatedate, startdate, enddate, isactive)
